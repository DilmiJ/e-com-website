...
import { FaEye, FaEdit, FaTrash, FaSearch, FaFilter, FaUser, FaUserShield } from 'react-icons/fa';
...
const UserManagement = () => {
  ...
  const roleOptions = [
    { value: 'user', label: 'User', color: 'bg-blue-100 text-blue-800', icon: FaUser },
    { value: 'admin', label: 'Admin', color: 'bg-purple-100 text-purple-800', icon: FaUserShield }
  ];
  ...
  const updateUserRole = async (userId, newRole) => {
    try {
      ...
      await api.put(`/users/admin/${userId}/role`, 
        { role: newRole }
      );
          ...
          <div className="p-6 border-b border-gray-200">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
              ...
              <div className="bg-green-50 p-4 rounded-lg text-center">
                <div className="text-2xl font-bold text-green-600">{userStats.regularUsers || 0}</div>
                <div className="text-sm text-green-600">Regular Users</div>
              </div>
              <div className="bg-orange-50 p-4 rounded-lg text-center">
                <div className="text-2xl font-bold text-orange-600">{userStats.recentUsers || 0}</div>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center gap-2">
                      ...
                      <span className={`inline-flex items-center px-2 py-1 text-xs font-semibold rounded-full ${getRoleColor(selectedUser.role)}`}>
                        {React.createElement(getRoleIcon(selectedUser.role), { className: "mr-1" })}
                        {selectedUser.role}
                      </span>
                    </div>
