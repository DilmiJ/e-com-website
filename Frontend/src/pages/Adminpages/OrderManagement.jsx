                ...
                <tbody>
                  {filteredOrders.map(order => (
                    <tr key={order._id} className="border-t hover:bg-gray-50">
                      ...
                      <td className="p-2">{order.userInfo?.name || order.userId?.name}</td>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    <p><strong>Name:</strong> {selectedOrder.userInfo?.name || selectedOrder.userId?.name || 'N/A'}</p>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <select
                        ...
                        disabled={updatingStatus}
                        className={`px-2 py-1 rounded text-sm border ${getStatusColor(selectedOrder.status)}`}
                      >
                        {statusOptions.map(option => (
                          <option key={option.value} value={option.value}>
                            {option.label}
                  ...
                  <table className="w-full border border-gray-200">
                    ...
                    <tfoot className="bg-gray-50">
                      <tr>
                        ...
                        <td className="px-4 py-2 text-sm font-bold text-gray-900">AED {selectedOrder.total?.toFixed(2)}</td>
                      </tr>
                    </tfoot>
                  </table>
                </div>
